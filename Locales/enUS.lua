...
BC.locales["enUS"] = {
  ...
  TOTAL_KILLS_RESET = "total kills reset to 0",
  CHARACTER_RECREATED = "character recreated detected - all data reset",
  NOT_ON_CHALLENGE = "This character is not on the Boaring Adventure challenge",
  ...
  HELP_RESETTOTAL = "  /boar resettotal   - reset total kills to 0",
