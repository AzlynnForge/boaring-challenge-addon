...
BC.locales["frFR"] = {
  ...
  TOTAL_KILLS_RESET = "total des kills réinitialisé à 0",
  CHARACTER_RECREATED = "personnage recréé détecté - toutes les données réinitialisées",
  NOT_ON_CHALLENGE = "Ce personnage n'est pas sur le Défi Sanglier",
  ...
  HELP_RESETTOTAL = "  /boar resettotal   - réinitialiser total des kills à 0",
